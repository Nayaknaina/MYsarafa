...
router.post('/like/:id', authMiddleware, announcementController.toggleLike);
router.get('/likes/:id', authMiddleware, announcementController.getLikes);

router.post('/comment/:id', authMiddleware, announcementController.addComment);
router.get('/comments/:id', authMiddleware, announcementController.getComments);
